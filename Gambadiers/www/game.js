...
function create() 
{
    ...
    tilemap = TileMap.create(new Phaser.Rectangle(0,0,worldBounds.getX(), worldBounds.getY()));
    ...
    */
    //PLAYER
    player = Player.create(Vector.create(worldBounds.getX()/2, worldBounds.getY()-64.0));
...
function update() 
{
    ...
    */
    ...
    worldScale = Phaser.Math.clamp(worldScale, 0.1, 1.0);
...
function cameraZoom()
{
    ...
    /*
    tileMapCrop.width = bounds.width;
    tileMapCrop.height = bounds.height;
    */

    //layer.cameraOffset = new Phaser.Point(game.camera.x, game.camera.y);
}
