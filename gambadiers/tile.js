var Tile = 
{
	...
	addSprite: function()
	{
	    ...
	    //console.log(this.sprite);
	    var range_value = rangeSlider.noUiSlider.get();
	    var colour = Phaser.Color.createColor(null, null, null, null, Number(range_value), 1.0, 1.0);
