...
var Player =
{
	...
	init: function(position)
	{
		...
		this._sprite = game.add.sprite(position.x, position.y,'player');
	...
	update: function()
	{
		...
		if (this._sprite.body.onFloor() || this._sprite.body.touching.down)
		{
		    this.canJump = true;
		}
    	...
    	if (cursors.up.isDown || wasd.up.isDown || player_touchcontrol.jump)
    	{
            ...
            */
    	    if (this.canJump)
    	    {
    	        this._sprite.body.velocity.y = -(this._speed * 5);
    	        this.canJump = false;
    	    }
