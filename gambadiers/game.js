...
var game = new Phaser.Game(browsersize.width/1.5, browsersize.height/1.5, Phaser.AUTO, '', { preload: preload, create: create, update: update, render: render }, false, false);
